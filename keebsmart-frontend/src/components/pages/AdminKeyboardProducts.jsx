...
import { getKeyboardsData, deleteProduct, activateProduct } from "../../server/productController";
...
export default function AdminKeyboardProducts() {
    ...
    useEffect(() => {
        getKeyboardsData(setKeyboards, (sold, name) => {
            setChartLabel(name);
            setChartSeries(sold);
        });
    }, [0]);
            ...
            <DashboardContent>
                <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className="flex flex-col gap-3 h-96 bg-white p-5 rounded-xl shadow-md">
                        ...
                        <DonutChart labels={chartLabel} series={chartSeries} width='550' />
                    </div>
                </div>
                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600" key={key}>
                                    ...
                                    <td class="px-6 py-4">
                                        <label class="inline-flex items-center mb-5 cursor-pointer mt-3 ml-1">
                                            <input defaultChecked={keyboard.isActive ? true : false} type="checkbox" value="true" class="sr-only peer" onChange={() => activateProduct(keyboard.id, !keyboard.isActive)}/>
