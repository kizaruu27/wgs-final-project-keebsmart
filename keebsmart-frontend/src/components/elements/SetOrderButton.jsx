...
export default function SetOrderButton({status, orderId}) {
    ...
    return <button onClick={() => setStatus(newStatus)} type="button" className={`focus:outline-none w-44 text-white ${btnColor} focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 my-5 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800`} disabled={btnIsDisabled}>{btnText}</button>
}