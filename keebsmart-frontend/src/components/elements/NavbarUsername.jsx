export default function NavbarUsername({linkTo, text, totalOrders}) {
    return (
        <>
                ...
                <ul className="py-2 text-sm text-gray-700 dark:text-gray-400" aria-labelledby="dropdownLargeButton">
                    <li>
                        <a href="/orders" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                            My Orders <span className="py-1 px-2 mx-2 text-white font-bold text-xs rounded-full bg-red-500">{totalOrders}</span>
                        </a>
                    </li>
                </ul>
                <div className="py-1">
