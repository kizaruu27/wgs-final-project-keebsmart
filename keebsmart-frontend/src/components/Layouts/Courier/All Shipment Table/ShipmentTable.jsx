...
export default function ShipmentTable ({shipments, onSeeDetail}) {
                        ...
                        <tbody>
                            {shipments.map((shipment, key) => (
                                <tr key={key} class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    ...
                                    <td class="px-6 py-4 text-nowrap">
                                        <span className="bg-blue-100 rounded-xl text-blue-800 text-xs font-medium me-2 px-2.5 py-0.5 text-nowrap">{shipmentStatus(shipment)} </span>
                                    </td>
                                    <td class="px-6 py-4">
