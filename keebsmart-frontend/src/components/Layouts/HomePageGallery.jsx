import Container from "../fragments/Container"; // Importing a container component for layout
import { ImageList, ImageListItem } from '@mui/material'; // Importing MUI components for image gallery
