...
export default function EditProductItemForm () {
    ...
    const [initialQty, setInitalQty] = useState(0);
    ...
    useEffect(() => {
        ...
        try {
            ...
            setDefaultFileNames(fetchedFiles.map(file => file.name));
        } catch (error) {
    ...
    const onImageChange = (e) => {
        ...
        // Update defaultFileNames only when there's a change in selected files
