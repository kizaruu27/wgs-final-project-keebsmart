...
export default function AddProductFormModal({openModal, setOpenModal}) {
    ...
    useEffect(() => {
        getAllinventory((data) => {
            setInventory(data.filter(item => !item.isUsed));
        })
    }, []);
                ...
                <form onSubmit={e => postNewProduct(e)}>
                    <div className="flex flex-col gap-3">
                        <div>
                            ...
                            <select onChange={(e) => setInventoryData(e.target.value)} id="productName" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <div>
                            <div className="mt-1">
                                ...
                                <input className="mt-1 block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="images" type="file" onChange={e => setImagePreview(e.target.files[0])} />
                            </div>
                        </div>
                        <div>
                            <div className="mt-1">
                                <label htmlFor="images">Other Images (Required)</label>
                                <input className="mt-1 block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="images" type="file" onChange={e => setImages(e.target.files)} multiple />
                            </div>
                        </div>
                        <div>
